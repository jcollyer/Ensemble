...
The mobile app is built and submitted through [EAS](https://docs.expo.dev/eas/) (Expo Application Services). See [`apps/mobile/README.md`](apps/mobile/README.md) for the full end-to-end release sequence.
