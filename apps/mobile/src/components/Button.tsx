...
/**
 * App-wide button. Keeps the web app's variant vocabulary (primary / outline
 * / ghost / destructive) so the two clients feel related. Text children get
 * auto-wrapped in a <Text>; pass arbitrary nodes if you need an icon.
 */
